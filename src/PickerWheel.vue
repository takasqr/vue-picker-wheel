...
<template>
  ...
  <!-- <v-dialog
    ...
    >
      <v-card>
        <v-card-text>
          <h3 class="mt-4">Google Search</h3>
          <v-chip
            class="ma-2"
            color="primary"
            v-for="searchOption in searchOptions"
            link
            :href="'https://www.google.com/search?q='+ cell[result - 1] + '%20' + searchOption"
            target="_blank"
            append-icon="mdi-magnify"
          >{{ cell[result - 1] + ' ' + searchOption }}</v-chip>

          <h3 class="mt-4">Google Maps</h3>
          <v-chip
            class="ma-2"
            color="primary"
            v-for="searchOption in searchOptions"
            link
            :href="'https://www.google.com/maps/search/?api=1&query='+ cell[result - 1] + '%20' + searchOption"
            target="_blank"
...
<style>
/* #roulette-restaurant___app---roulette {
  margin: auto;
  margin-top: 50px;
  margin-bottom: 50px;
  position: relative;
...
/* #roulette-restaurant___app---roulette::after {
  content: "";
  display: block;
  width: 40px;
  height: 40px;
...
/* #roulette-restaurant___app---roulette li {
  top: 0;
  right: 0;
  left: 0;
  margin: auto;
...
/* #roulette-restaurant___app---roulette li::before {
  top: 0;
  left: 0;
  position: absolute;
  display: inline-block;
...
/* #roulette-restaurant___app---roulette li:nth-of-type(1):after {
  content: "焼肉";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(2):after {
  content: "寿司";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(3):after {
  content: "イタリアン";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(4):after {
  content: "ラーメン";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(5):after {
  content: "和食";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(6):after {
  content: "海鮮";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(7):after {
  content: "そばうどん";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(8):after {
  content: "ハンバーグ";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(9):after {
  content: "ハンバーガー";
  writing-mode: vertical-lr;
}
#roulette-restaurant___app---roulette li:nth-of-type(10):after {
  content: "中華";
  writing-mode: vertical-lr;
} */

/* #roulette-restaurant___app---roulette li:nth-of-type(1):before {
  border-color: v-bind(colors[1]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(2):before {
  border-color: v-bind(colors[2]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(3):before {
  border-color: v-bind(colors[4]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(4):before {
  border-color: v-bind(colors[5]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(5):before {
  border-color: v-bind(colors[7]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(6):before {
  border-color: v-bind(colors[9]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(7):before {
  border-color: v-bind(colors[11]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(8):before {
  border-color: v-bind(colors[12]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(9):before {
  border-color: v-bind(colors[14]) transparent transparent;
}
#roulette-restaurant___app---roulette li:nth-of-type(10):before {
  border-color: v-bind(colors[15]) transparent transparent;
} */
